...
mongoose.connect("mongodb+srv://Mayur99:Mayurmore99@mayurapi.nnwuki6.mongodb.net/todolistDB?retryWrites=true&w=majority",{
...
app.post("/delete",function(req,res){
  ...
  if(listName === "Today"){
    ...
    Item.findByIdAndRemove(checkItemId,function(err){
      if(!err){
        console.log("sucessfully deleted checke item.");
        res.redirect("/");
      };
    });
